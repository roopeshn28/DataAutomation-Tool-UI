...
lanlist=[
    "Afrikaans", "Amharic", "Arabic", "Assamese", "Azerbaijani", "Belarusian", "Bengali", "Tibetan",
...
class PageFive(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        opt.config(width=90, font=('Helvetica', 12))
        opt.pack(side="top", pady=25)
        print("Selected Language 1 is",language1.get())
        print("Selected Language 2 is", language2.get())
        #selectfilebutton = tk.Button(self, text="Select File", command=performtranslation(language1.get(),language2.get()))
        #selectfilebutton.pack(pady=10)
        button = tk.Button(self, text="Go to the start page",
                           command=lambda: controller.show_frame("StartPage"))
        button.pack(pady=10)
