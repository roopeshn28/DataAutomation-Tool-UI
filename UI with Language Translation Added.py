...
def performtranslation(lan1,lan2,file):
    ...
    storagename = files + "_" + lan1 +" to "+lan2
...
def displayimage(image,width,height):
    root=tk.Toplevel()
    print("Path of the imaghe is",image)
    print("Width and height of the imaghe is",width ," ",height)
