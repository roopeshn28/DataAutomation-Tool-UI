...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        OptionList = ["Afrikaans","Amharic","Arabic","Assamese","Azerbaijani","Belarusian","Bengali","Tibetan","Bosnian","Bulgarian","Catalan","Valencian","Cebuano","Czech",
                      "Chinese-Simplified ","Chinese-Traditional ","Cherokee","Welsh","Danish","German","Dzongkha","Greek",
                      "English","Esperanto","Estonian","Basque","Persian","Finnish","French","German Fraktur",
                      "Irish","Galician","Greek","Gujarati","Haitian","Haitian Creole","Hebrew","Hindi",
                      ...
                      "Oriya","Panjabi","Punjabi","Polish","Portuguese","Pushto","Pashto","Romanian","Moldavian",
                      "Moldovan","Russian","Sanskrit","Sinhala","Sinhalese","Slovak","Slovenian","Spanish","Castilian",
                      "Castilian - Old","Albanian","Serbian","Serbian - Latin","Swahili","Swedish","Syriac","Tamil",
                      "Telugu","Tajik","Tagalog","Thai","Tigrinya","Turkish","Uighur","Uyghur","Ukrainian","Urdu",
